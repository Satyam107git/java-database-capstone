...
public class AppointmentService {
    ...
    public ResponseEntity<Map<String, String>> cancelAppointment(long id, String token) {
        ...
        // Long patientIdFromToken = tokenService.extractIdentifier(token);
        ...
        Long patientIdFromToken = patient.getId();
    ...
    // ===============================
    // 4️⃣ Get Appointments (Doctor Dashboard)
    // ===============================
...
// // - To indicate that this class is a service layer class for handling
// business logic.
// // - The `@Service` annotation should be added before the class declaration
...
// is available for updating, and ensures that the doctor is available at the
// specified time.
...
// // - It ensures the patient who owns the appointment is trying to cancel it
...
// // - Instruction: Ensure the correct use of transaction boundaries,
// especially when querying the database for appointments.

// // 8. **Change Status Method**:
// // - This method updates the status of an appointment by changing its value
// in the database.
