...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    /* -------------------------------------------------------
       1. Appointments for doctor within time range
    -------------------------------------------------------- */
    @Query("""
    ...
    /* -------------------------------------------------------
       2. Filter by doctorId + partial patient name + time range
    -------------------------------------------------------- */
    @Query("""
           SELECT a FROM Appointment a
           LEFT JOIN FETCH a.doctor d
    ...
    /* -------------------------------------------------------
       3. Delete all appointments of a doctor
    -------------------------------------------------------- */
    @Modifying
    @Transactional
    ...
    /* -------------------------------------------------------
       5. Get appointments by patient + status ordered by time
    -------------------------------------------------------- */
